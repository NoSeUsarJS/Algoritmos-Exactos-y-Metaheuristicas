...
num_generations = 1000  # Número de generaciones (Parametro)
num_parents_mating = 5  # Número de padres que se seleccionarán para reproducirse (Parametro)
sol_per_pop = 20  # Tamaño de la población (Parametro)
